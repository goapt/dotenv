...
func TestReadPlainEnv(t *testing.T) {
	envFileName := "testdata/plain.env"
...
func TestLoadExportedEnv(t *testing.T) {
	envFileName := "testdata/exported.env"
	expectedValues := map[string]string{
		"OPTION_A": "2",
		"OPTION_B": "\\n",
	}
...
func TestLoadEqualsEnv(t *testing.T) {
	envFileName := "testdata/equals.env"
	expectedValues := map[string]string{
...
func TestLoadQuotedEnv(t *testing.T) {
	envFileName := "testdata/quoted.env"
	expectedValues := map[string]string{
		"OPTION_A": "1",
		"OPTION_B": "2",
		"OPTION_C": "",
...
func TestSubstitutions(t *testing.T) {
	envFileName := "testdata/substitutions.env"
	expectedValues := map[string]string{
		"OPTION_A": "1",
		"OPTION_B": "1",
		"OPTION_C": "1",
...
func TestErrorParsing(t *testing.T) {
	envFileName := "testdata/invalid1.env"
	envMap, err := Read(envFileName)
	if err == nil {
		t.Errorf("Expected error, got %v", envMap)
	}
...
func TestRoundtrip(t *testing.T) {
	testdata := []string{"equals.env", "exported.env", "plain.env", "quoted.env"}
	for _, fixture := range testdata {
		fixtureFilename := fmt.Sprintf("testdata/%s", fixture)
